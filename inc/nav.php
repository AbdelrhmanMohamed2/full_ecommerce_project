    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
                ...
                <?php else : ?>
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu">
                            <li><a class="dropdown-item" href="<?= URL ?>inc/mode.php?mode=lite">Lite</a></li>
                            <li><a class="dropdown-item" href="<?= URL ?>inc/mode.php?mode=dark">Dark</a></li>
                        </ul>
                    </li>
            </ul>
            ...
            <ul class="navbar-nav mx-2">
                ...
                <li class="nav-item mx-2">
                    <a href="<?= URL ?>wishList/user_wishList.php" class="btn btn-primary">
